...
//        locationUtil.getOnceLocation();//获取一次位置
    ...
    private void initShareInfo() {
        ...
        ShareConstant.getIns().setWeiboScope("email,direct_messages_read,direct_messages_write," + "friendships_groups_read,friendships_groups_write,statuses_to_me_read,"
