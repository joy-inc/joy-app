 ...
 */
public class BookSubjectWidget extends ExLayoutWidget {

    private LinearListView mLinearLv;
    private LevelAdapter mAdapter;

    public BookSubjectWidget(Activity activity) {
        ...
        private class DataViewHolder extends ExViewHolderBase {
            ...
            public void invalidateConvertView() {
                ...
                if (data != null) {
                    ...
                    if (TextUtil.isEmpty(data.getLocalContent()) && CollectionUtil.isNotEmpty(data.getOptions())) {
                        tvContent.setText(data.getOptions().get(0).getContent());
                        data.setLocalSelectId(data.getOptions().get(0).getOption_id());
                    } else
            ...
            public int getConvertViewRid() {
                ...
                return R.layout.item_order_level_subject;
            }
