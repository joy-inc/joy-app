...
public class AutoChangeLineViewGroup extends ViewGroup {
    ...
    public AutoChangeLineViewGroup(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.AutoChangeLineViewGroup);
        horizontalSpacing = a.getDimensionPixelSize(R.styleable.AutoChangeLineViewGroup_horSpacing, 0);
        verticalSpacing = a.getDimensionPixelSize(R.styleable.AutoChangeLineViewGroup_verSpacing, 0);
        lines = a.getInteger(R.styleable.AutoChangeLineViewGroup_showLines, Integer.MAX_VALUE);
        a.recycle();
    }
