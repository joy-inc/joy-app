...
public class FoldTextView extends TextView {
    ...
    protected void onDraw(@NonNull Canvas canvas) {
        ...
        if (mIsFolded) {// 折叠状态
            ...
            for (int i = 0; i < mFoldTexts.size(); i++) {
                ...
                if (mIsFoldEnable && i == mFoldTexts.size() - 1) {
    ...
    private void initTextInfo(ArrayList<String> container, Paint paint) {
        ...
        for (int i = 0; i < STR_LENGTH; i++) {
            ...
            if (curWidth == availableWidth || (curWidth < availableWidth && nextIndex < strWidths.length && curWidth + strWidths[nextIndex] > availableWidth)) {
