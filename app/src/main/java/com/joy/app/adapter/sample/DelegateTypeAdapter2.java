...
public class DelegateTypeAdapter2 extends AdapterDelegateImpl<DelegateBean1, DelegateTypeAdapter2.ViewHolder> {

    public static final int TYPE_VALUE = 2;// 跟接口约定好的值
