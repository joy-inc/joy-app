...
public class DelegateTypeAdapter1 extends AdapterDelegateImpl<DelegateBean1, DelegateTypeAdapter1.ViewHolder> {

    public static final int TYPE_VALUE = 1;// 跟接口约定好的值
